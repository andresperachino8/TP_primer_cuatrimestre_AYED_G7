...
public class Jugador {
    ...
    public Jugador(String nombre, String apellido, int edad, String nombre_equipo, boolean capitan, boolean subcapitan,
            boolean comodin,
    ...
    public void altaJugador() {
        ...
        while (contador < 3) {
            ...
            System.out.println("Ingrese el nombre del equipo del jugador [" + (contador + 1) + "/" + njugadores + "]");
            ...
            Jugador nj = new Jugador(nombre, apellido, edad, nombre_equipo, capitan,
                    subcapitan, comodin, fotocopia_dni, fotocopia_prepaga, apto_medico);
    ...
    public void muestraJugadores(Jugador[] e) {
        ...
        for (int i = 0; i < jugadores.length; i++) {
            System.out.printf("| %-10s | %-10s | %-4d | %-12s | %-8s | %-9s | %-6s | %-13s | %-16s | %-12s |\n",
                    jugadores[i].nombre, jugadores[i].apellido, jugadores[i].edad, jugadores[i].nombre_equipo,
                    jugadores[i].capitan ? "Sí" : "No", jugadores[i].subcapitan ? "Sí" : "No",
                    jugadores[i].comodin ? "Sí" : "No",
                    jugadores[i].fotocopia_dni ? "Sí" : "No", jugadores[i].fotocopia_prepaga ? "Sí" : "No",
